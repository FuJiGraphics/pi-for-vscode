...
export const actionDividerEl = byId<HTMLElement>("actionDivider");
...
export const editBannerEl = byId<HTMLElement>("editBanner");
export const editCancelEl = byId<HTMLButtonElement>("editCancel");
...
export const statusStripEl = byId<HTMLElement>("statusStrip");
export const sessionStatsEl = byId<HTMLElement>("sessionStats");
export const usageBarsEl = byId<HTMLElement>("usageBars");
